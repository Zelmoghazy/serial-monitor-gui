...
set LIBRARIES=opengl32.lib glfw3.lib glew32.lib Dwmapi.lib user32.lib gdi32.lib shell32.lib kernel32.lib Comdlg32.lib

pushd .\build
cl /Zi /EHsc /D_M_AMD64 /W4 /MD /nologo %INCLUDE_DIRS% ..\Main.cpp ..\external\src\*.cpp ..\src\*.cpp /link %LIBRARY_DIRS% %LIBRARIES%
.\Main.exe
popd
